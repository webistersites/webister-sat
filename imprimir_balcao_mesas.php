...
// $connector = new WindowsPrintConnector("smb://balcao-pc/cozinha");
...
if (mysql_num_rows($query_impressao) > 0) 
{
    ...
    {
       $fh = fopen("cupom_balcao_mesas.txt", "rb");
       $content = fread($fh, filesize("cupom_balcao_mesas.txt"));
       fclose($fh);
