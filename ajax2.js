...
function listaCaixa2(id) {
	//var id      = document.getElementById("id").value;
        
	var result  = document.getElementById("result");
	var XMLHttp = generateXMLHttp();
	XMLHttp.open("get", "insertDataBalcao2.php?id=" + id, true);
	XMLHttp.onreadystatechange = function(){
		if (XMLHttp.readyState == 4)
			if (XMLHttp.status == 200){
				result.innerHTML = XMLHttp.responseText;
...
function deletaBalcao(id) {
	//var id      = document.getElementById("id").value;
        
	var result  = document.getElementById("result");
	var XMLHttp = generateXMLHttp();
	XMLHttp.open("get", "deletaDataBalcao.php?id_del=" + id, true);
	XMLHttp.onreadystatechange = function(){
		if (XMLHttp.readyState == 4)
			if (XMLHttp.status == 200){
				result.innerHTML = XMLHttp.responseText;
...
function insereSaboresBalcao() {
	var sabor1      = document.getElementById("course_sabores").value;
	var sabor2      = document.getElementById("course_sabores2").value;
	var result  = document.getElementById("result");
	var XMLHttp = generateXMLHttp();
	XMLHttp.open("get", "recebe_sabores_balcao.php?sb1=" + sabor1 + "&sb2=" + sabor2, true);
	XMLHttp.onreadystatechange = function(){
		if (XMLHttp.readyState == 4)
			if (XMLHttp.status == 200){
				result.innerHTML = XMLHttp.responseText;
