...
mysql_query("UPDATE pedido_balcao2 SET impresso = 1");
...
if (mysql_num_rows($query_impressao) > 0) 
{
    ...
    {
       $fh = fopen("cupom_balcao_cx2.txt", "rb");
       $content = fread($fh, filesize("cupom_balcao_cx2.txt"));
       fclose($fh);
