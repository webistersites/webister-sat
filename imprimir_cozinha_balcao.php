...
$q_senha    = mysql_query("SELECT sum(senha),senha from pedido_balcao2");
 ...
 if ($senha == 0) 
 {
     ...
     mysql_query("UPDATE pedido_balcao2 SET senha = $nf");
 }
 else
 {
...
if (mysql_num_rows($query_impressao) > 0) 
{
    ...
    {
       $fh = fopen("cupom_cozinha2.txt", "rb");
       $content = fread($fh, filesize("cupom_cozinha2.txt"));
       fclose($fh);
        ...
        mysql_query("UPDATE pedido_balcao2 SET impresso = 1 where cozinha = 1");
...
?>
 <meta http-equiv="refresh" content="0.1; url=imprimir_balcao_cx2.php">
