        ...
        while ($data = mysql_fetch_array($busca)) 
            {
                ...
                $return .= "<a href='imprimir_cozinha.php' class='ui grey fluid tiny button'>Imprimir</a>";
                        ...
                        if (mysql_num_rows($consulta) == 0) 
                            {
                                ...
                                mysql_query("INSERT INTO pedido_balcao VALUES ('',(SELECT id FROM tec_products WHERE concat(name,cost) = '".$produto.$preco1."'),1,'',0,0)");
                            }
                        else
                        {
                            //$resultado = mysql_fecth_array($consulta);
                            mysql_query("INSERT INTO pedido_balcao VALUES ('',(SELECT id FROM tec_products WHERE concat(name,cost) = '$concatenar'),1,'',0,0)");
                        }
                    }
                        ...
                        if (mysql_num_rows($consulta) == 0) 
                            {
                                ...
                                mysql_query("INSERT INTO pedido_balcao VALUES ('',(SELECT id FROM tec_products WHERE concat(name,cost) = '".$produto.$preco2."'),1,'',0,0)");
                            }
                        else
                        {
                            //$resultado = mysql_fecth_array($consulta);
                        ...
                        if (mysql_num_rows($consulta) == 0) 
                            {
                                ...
                                mysql_query("INSERT INTO pedido_balcao VALUES ('',(SELECT id FROM tec_products WHERE concat(name,cost) = '".$produto.$preco3."'),1,'',0,0)");
                            }
                        else
                        {
                            //$resultado = mysql_fecth_array($consulta);
