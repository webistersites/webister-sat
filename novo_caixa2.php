...
<div class="ui two column doubling stackable grid container">
    ...
    <?php
        ...
        echo '$("result").ready(function(){
                 $("#finalizar_caixa").click(function(){
                  $("#refresh").load("forma_pagamento_balcao.php");
                 });
                });';
        echo "</script>";
        echo "<p>"
        ...
        echo '<a href="balcaoDAO2.php?truncar=yes" id="cancelar_caixa" class="ui red button">Cancelar Venda</a>';
  ...
  $.ajax({
    ...
    <?php 
        echo "<script>";
        echo '$("result").ready(function(){
                 $("#dois_sabores_balcao").click(function(){
                  $("#refresh").load("dois_sabores_balcao.php");
                 });
                });';
        echo "</script>";
        echo "<script>";
  ...
  <div class="column">
    ...
    <p>
        <a href="javascript:void(0);" id="dois_sabores_balcao" class="ui basic button">2 Sabores</a>
    ...
    <div class="ui bottom attached segment" id="refresh">
      <p>
        <?php
            ...
            include 'dois_sabores_balcao.php';
        ?>
          </p>
        </div>
      </p>
