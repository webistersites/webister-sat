    ...
    <body>
        <div id="content" class="ui form">
            <form autocomplete="off" onsubmit="return false;">
                ...
                <input value="Selecionar" id="meuBotao" onclick="insereSaboresBalcao()" type="button" />
                <br>
                <a href="javascript:void(0);" class="ui teal right floated button" onclick="insereSaboresBalcao()">Selecionar</a>
                <br><br>
            </form>
        </div>
