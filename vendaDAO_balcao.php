<?php
  ...
  if ($forma == 2 || $forma == 3) // Verifica se é crédito ou débito e registra entrada;
    { 
        ...
        $insereMov = mysql_query("INSERT pde_movimentacao SELECT '','E',$valorEntrada,'Caixa 02',$forma,$nf");
    ...
    elseif ($forma == 4) // Verifica se é Dinheiro + Débito (2);
    {
        $valorEntrada = $_GET['din'];
        $resto = $_GET['resto'];
        mysql_query("INSERT pde_movimentacao SELECT '','E',$valorEntrada,'Caixa 02',1,$nf");
        mysql_query("INSERT pde_movimentacao SELECT '','E',$resto,'Caixa 02',2,$nf");
    }
    elseif ($forma == 5) // Verifica se é Dinheiro + Crédito (3);
    {
        ...
        $resto = $_GET['resto'];
        mysql_query("INSERT pde_movimentacao SELECT '','E',$valorEntrada,'Caixa 02',1,$nf");
        mysql_query("INSERT pde_movimentacao SELECT '','E',$resto,'Caixa 02',3,$nf");
    }
    elseif ($forma == 1 && $troco != 0) // Verifica se é Dinheiro;
    {
        ...
        $mov = mysql_query(
                ...
                . " VALUES"
                . " ('E',$valorEntrada,'Caixa 02',1,$nf),"
                . " ('S',$troco,'Caixa 02',1,$nf)"
                );
    }
    else 
    {
  ...
  mysql_query("INSERT pde_fato_vendas SELECT '','".$date."','Caixa 02',$nf,0,'".$forma."',".$max_id_caixa.",'A',0");
